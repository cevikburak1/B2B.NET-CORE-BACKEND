...
namespace DataAccess.Context.EntityFramework
{
    public class SimpleContextDb : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=DESKTOP-LRDHV9F;Database=B2BDb;Integrated Security=true;");
        }
        ...
        public DbSet<CustomerRelationShips> CustomerRelationShipses { get; set; }
