...
namespace Business.DependencyResolvers.Autofac
{
    public class AutofacBusinessModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<CustomerRelationShipsManager>().As<ICustomerRelationShipsService>().SingleInstance();
            builder.RegisterType<EfCustomerRelationShipsDal>().As<ICustomerRelationShipsDal>().SingleInstance();
